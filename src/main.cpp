...
#if defined(NDEBUG)
# error "stripecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x334a3657c94ef082a00abcd70c2753a77665b35e3efb8d8b7c4ae5eb54fefe6e");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // stripecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "stripecoin Signed Message:\n";
...
{
    // stripecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
nSubsidy = 100 * COIN;
    ...
    nSubsidy >>= (nHeight / 840000); // stripecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // stripecoin: 5 minutes
static const int64 nTargetSpacing = 1 * 45; // stripecoin: 45 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // stripecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // stripecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x334a3657c94ef082a00abcd70c2753a77665b35e3efb8d8b7c4ae5eb54fefe6e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 02/AUG/2015 Obama to Unveil Tougher Climate Plan With His Legacy in Mind";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1438494275;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2681143;
        ...
        assert(block.hashMerkleRoot == uint256("0x6db2c1c6df22c7f6ee79eb4604330913b6d056db1798c8a61b90e79ec265f6b5"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // stripecoin: increase each by adding 2 to bitcoin's value.
